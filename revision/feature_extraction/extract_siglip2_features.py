...
OUTPUT_DIR = Path(os.environ.get("BAYC_SIGLIP2_OUTPUT_DIR", ROOT / "revision" / "siglip2_features_20260909")).resolve()
...
CHECKPOINT_DIR = Path(os.environ.get(
    "SIGLIP2_CHECKPOINT_DIR",
    ROOT / "tmp" / "siglip2_timing" / "hf_cache" / "hub" / "models--google--siglip2-large-patch16-256" / "snapshots" / "787800c8990e6f058423089178e718139608408c",
)).resolve()
